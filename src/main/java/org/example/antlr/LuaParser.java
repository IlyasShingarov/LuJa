...
public class LuaParser extends Parser {
	...
	public static final int
		...
		TYPE_T=61, TYPE_V=62, TYPE_A=63, NAME=64, NORMALSTRING=65, CHARSTRING=66, 
		LONGSTRING=67, INT=68, HEX=69, FLOAT=70, HEX_FLOAT=71, COMMENT=72, WS=73, 
		NL=74, SHEBANG=75;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"TYPE_F", "TYPE_S", "TYPE_B", "TYPE_T", "TYPE_V", "TYPE_A", "NAME", "NORMALSTRING", 
	...
	public final RetstatContext retstat() throws RecognitionException {
		...
		try {
			...
			case RETURN:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((((_la - 24)) & ~0x3f) == 0 && ((1L << (_la - 24)) & 280377616761591L) != 0)) {
					{
					setState(188);
					explist();
					}
	...
	public final TableconstructorContext tableconstructor() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 24)) & ~0x3f) == 0 && ((1L << (_la - 24)) & 280377633538807L) != 0)) {
				{
				setState(467);
				fieldlist();
				}
	...
	public static class TypehintContext extends ParserRuleContext {
		...
		public TerminalNode TYPE_A() { return getToken(LuaParser.TYPE_A, 0); }
